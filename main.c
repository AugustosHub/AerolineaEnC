...
Si se llena el avión debe decir: "El siguiente vuelo parte en tres horas".
*/
#include <stdio.h>
#include <stdlib.h>
#include<wchar.h>
...
int main()
{
    ...
    puts("  5. Ver recaudación del vuelo");
    puts("  6. Salir");
    puts("-----------------------------------");
    printf("Opción: ");
    scanf("%d",&op);
...
//////////////////////////////////////////////////////////////////////////////////
            case 3:
                ...
                switch(op){
                    case 1:
                        system("cls");
                        printf("¿De qué clase es la reserva?\n\n");
...
//////////////////////////////////////////////////////////////////////////////////
            case 5:
                system("cls");
                puts("-----------------------------------------------------------------");
                printf("La recaudación del vuelo n°%d hasta el momento es: %.2f\n",aleatorio,recaudacion);
                puts("-----------------------------------------------------------------");
                system("pause");
                break;
...
//////////////////////////////////////////////////////////////////////////////////
            case 6:
                system("cls");
                printf("¿Seguro que desea salir de la aplicación?\n");
                printf("1. Si\n");
                printf("2. No\n");
                printf("Opción: ");
                scanf("%d",&op);
